...
public class OpenApiConfiguration {
    ...
    public OpenAPI learningPlatformOpenApi() {
        ...
        openApi.info(new Info()
                        .title("Hotech Platform Report Microservice API")
                        .description("Hotech application Report Microservice REST API documentation.")
                        .version("v1.0.0")
        ...
        if (isRunningInProd) {
            ...
            openApi.servers(Collections.singletonList(new Server().url("http://localhost:8006")));
        }
